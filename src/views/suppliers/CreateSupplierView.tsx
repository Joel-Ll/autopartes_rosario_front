    ...
    <div data-aos="fade-in" data-aos-duration="300">
      <Card className="w-full max-w-6xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Ingrese los datos del fomulario
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-4">
            ...
            <div className='grid gap-5 md:grid-cols-2'>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor={field.name}>Nombre de contácto</FieldLabel>
                    <Input
                      {...field}
                      id={field.name}
                      aria-invalid={fieldState.invalid}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor={field.name}>Teléfono de contácto</FieldLabel>
                    <Input
                      {...field}
                      id={field.name}
                      aria-invalid={fieldState.invalid}
