...
import { AlertTriangle, ArrowLeft, DollarSign, Edit2, LayoutGrid, MoreVertical, Package, PlusCircle, XCircle } from 'lucide-react'
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">{data.category.description}</p>
                </div>
              </div>

              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="secondary" disabled={!data.category.isActive}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Card className='py-0'>
              <CardContent className="flex items-center gap-5 p-6">
                ...
                <div className="space-y-0.5">
                  <p className="text-3xl font-bold leading-none">{data.stats.lowStockCount}</p>
            ...
            <Card className='py-0'>
              <CardContent className="flex items-center gap-5 p-6">
                ...
                <div className="space-y-0.5">
                  <p className="text-3xl font-bold leading-none">{data.stats.outOfStockCount}</p>
            ...
            <Card className="py-0">
              <CardContent className="flex items-center gap-5 p-6">
                ...
                <div className="space-y-0.5">
                  <p className="text-3xl font-bold leading-none">
                    <span className="text-2xl">Bs. </span> {data.stats.inventoryValue.toLocaleString()}
                  </p>
